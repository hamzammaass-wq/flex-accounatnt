...
const AIAssistant: React.FC<AIAssistantProps> = ({ onOpenVoiceAssistant }) => {
  ...
  const assistantDisplayName = tr('المحاسب فلكس', 'Flex Accountant');
  const assistantWelcomeTitle = tr('مرحبًا بك في المحاسب فلكس 👋', 'Welcome to Flex Accountant');
  ...
  const assistantMarketingTitle = tr(
    ...
    'Flex Accountant - Let intelligence run your numbers'
  );
  const assistantMarketingDescription = tr(
    ...
    'Take your accounting to a new level with Flex Accountant. It uses AI to analyze your financial data, automate daily entries, and deliver smart recommendations that support faster and more confident financial decisions.'
  );
