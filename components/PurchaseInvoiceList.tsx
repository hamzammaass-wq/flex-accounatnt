        ...
        <div className="app-page purchase-list-page animate-in fade-in duration-500 p-4" dir={isEnglish ? 'ltr' : 'rtl'}>
          ...
          <div className="list-card bg-white p-4 rounded-[2rem] border border-gray-100 shadow-sm mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-3">
              <select value={filterSupplierId} onChange={(e) => setFilterSupplierId(e.target.value)} className="w-full p-3 bg-gray-50 rounded-xl border border-gray-100 text-xs font-black outline-none">
