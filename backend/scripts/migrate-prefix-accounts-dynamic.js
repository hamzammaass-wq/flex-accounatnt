...
const migrate = async () => {
  ...
  try {
    ...
    // 1. Alter all possible account columns to VARCHAR(100)
    console.log('Altering ID columns to VARCHAR(100)...');
    const alterQueries = [
      'ALTER TABLE accounts ALTER COLUMN id TYPE VARCHAR(100)',
      'ALTER TABLE accounts ALTER COLUMN parent_id TYPE VARCHAR(100)',
      'ALTER TABLE contacts ALTER COLUMN linked_account_id TYPE VARCHAR(100)',
      'ALTER TABLE contacts ALTER COLUMN current_account_id TYPE VARCHAR(100)',
      'ALTER TABLE contacts ALTER COLUMN capital_account_id TYPE VARCHAR(100)',
      'ALTER TABLE contacts ALTER COLUMN drawings_account_id TYPE VARCHAR(100)',
      'ALTER TABLE journal_lines ALTER COLUMN account_id TYPE VARCHAR(100)',
      'ALTER TABLE invoices ALTER COLUMN payment_account_id TYPE VARCHAR(100)',
      'ALTER TABLE invoice_items ALTER COLUMN account_id TYPE VARCHAR(100)',
      'ALTER TABLE fixed_asset_groups ALTER COLUMN asset_account_id TYPE VARCHAR(100)',
      'ALTER TABLE fixed_asset_groups ALTER COLUMN accumulated_depreciation_account_id TYPE VARCHAR(100)',
      'ALTER TABLE fixed_asset_groups ALTER COLUMN depreciation_expense_account_id TYPE VARCHAR(100)'
    ];

    // Drop constraints first to allow type alteration without issues
