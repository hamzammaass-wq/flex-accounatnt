...
const messages = {
  "ar": {
    ...
    "auth.appName": "المحاسب الذكي (AIFLEX Smart Accountant)",
  ...
  "en": {
    ...
    "settings.optionArabic": "Arabic / العربية",
    "settings.optionEnglish": "English",
    ...
    "auth.appName": "AIFLEX Smart Accountant",
